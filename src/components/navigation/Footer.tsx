import logo5 from '../../assets/logos/4.png';

const Footer = () => {        
    return (
        <footer className="py-12 bg-white sm:py-16 lg:py-20 font-helvetica-bold-condensed">
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <img className="w-auto h-36 mx-auto" src={logo5} alt="" />
        ...
        <ul className="flex flex-wrap items-center justify-center space-x-12 md:space-x-16 mt-14">
            ...
            <li>
                <a href="#" title="" className="inline-flex text-lg font-medium text-gray-900 transition-all duration-200 transform font-pj hover:-translate-y-1 hover:text-gray-600"> FAQ </a>
            </li>

            <li>
                <a href="#" title="" className="inline-flex mt-0 text-lg font-medium text-gray-900 transition-all duration-200 transform font-pj hover:-translate-y-1 hover:text-gray-600 sm:ml-0 sm:mt-0"> Reviews </a>
            </li>

            <li>
                <a href="#" title="" className="inline-flex mt-0 text-lg font-medium text-gray-900 transition-all duration-200 transform font-pj hover:-translate-y-1 hover:text-gray-600 sm:mt-0"> Contact </a>
            </li>
        </ul>
        ...
        <p className="text-base font-normal text-center text-gray-600 mt-7 font-pj">© 2024 BugsBGone Inc.</p>
    </div>
</footer>
