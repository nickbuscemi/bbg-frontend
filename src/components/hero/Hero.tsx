...
export const Hero: React.FC = () => {
  ...
  return (
    <div className="bg-white">
      <section className="bg-white bg-opacity-30 py-0 sm:py-0 lg:py-6 lg:pb-32 font-helvetica-bold-condensed">
        <div className="px-4 mx-auto  sm:px-6 lg:px-24">
          <div className="grid items-center grid-cols-1 gap-12 xl:grid-cols-3">
            <div className="text-center lg:text-left max-w-2xl">
              <p className="text-base font-semibold tracking-wider text-emerald-600 uppercase">Serving Long Island and New York City</p>
            ...
            <div className='xl:col-span-2 flex justify-end'>
              <img className="rounded-sm w-full lg:w-3/4 xl:h-[620px] xl:object-cover animate__animated pb-10" src={currentImage} alt="Hero" />
            </div>
          </div>
        </div>
      </section>
